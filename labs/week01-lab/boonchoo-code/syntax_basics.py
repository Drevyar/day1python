...
name = "Mafueng"  # Replace with your actual name
age = 19  # Replace with your actual age
height = 170 # Replace with your height in feet
...
current_year = int(input('What year you were born :'))

# Float variable with your favorite number (with decimal)
favorite_number = int(input('waht is your favorite number :')) 

# Boolean variable indicating if you like pizza
likes_pizza = input('Do you like pizze (Yes / No) :').lower() == 'yes'
